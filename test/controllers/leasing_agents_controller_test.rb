...
class LeasingAgentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create leasing_agent" do
    assert_difference('LeasingAgent.count') do
      post leasing_agents_url, params: { leasing_agent: { agent_id: @leasing_agent.agent_id, email: @leasing_agent.email, name: @leasing_agent.name, password_digest: @leasing_agent.password_digest, phone_number: @leasing_agent.phone_number } }
    end
  ...
  test "should update leasing_agent" do
    patch leasing_agent_url(@leasing_agent), params: { leasing_agent: { agent_id: @leasing_agent.agent_id, email: @leasing_agent.email, name: @leasing_agent.name, password_digest: @leasing_agent.password_digest, phone_number: @leasing_agent.phone_number } }
